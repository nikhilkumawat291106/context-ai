...
<div class="sidebar">
    ...
    <div class="contacts-list">
        ...
        <div class="contact-item"
             onclick="openChat('Priya')">

            <div class="contact-avatar">P</div>

            <div class="contact-details">
                <h4>Priya</h4>
                <p>Let's submit today...</p>
            </div>
        ...
        <div class="contact-item"
            ...
            <div class="contact-details">
                <h4>Rahul</h4>
                <p>Dependency Injection improves...</p>
            </div>
        ...
        <div class="contact-item"
             onclick="openChat('Aditi')">

            <div class="contact-avatar">A</div>

            <div class="contact-details">
                <h4>Aditi</h4>
                <p>Can you review this message?</p>
            </div>
        ...
        <div class="contact-item"
             onclick="openChat('Shivani')">

            <div class="contact-avatar">S</div>

            <div class="contact-details">
                <h4>Shivani</h4>
                <p>Hackathon starts soon...</p>
            </div>
...
<div class="modal-content">
    ...
    <textarea id="followupQuestion"
              placeholder="Example: Explain in Hindi"></textarea>
